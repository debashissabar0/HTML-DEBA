...
public class ViewButton extends LinearLayout {
	...
	private void initAttributes(TypedArray attrs) {
		...
		backgroundColor = attrs.getColor(R.styleable.ViewButton_debashis_backgroundColor, backgroundColor);
		disableColor = attrs.getColor(R.styleable.ViewButton_debashis_disableColor, disableColor);
		focusColor = attrs.getColor(R.styleable.ViewButton_debashis_focusColor, focusColor);
		shape = attrs.getInt(R.styleable.ViewButton_debashis_shape, shape);

		borderWidth = attrs.getDimensionPixelSize(R.styleable.ViewButton_debashis_borderWidth, borderWidth);
		borderColor = attrs.getInt(R.styleable.ViewButton_debashis_borderColor, borderColor);

		radius = attrs.getDimension(R.styleable.ViewButton_debashis_radius, radius);
