...
public class StylesButton extends LinearLayout {
	...
	public StylesButton(Context context) {
		super(context);
	...
	public StylesButton(Context context, AttributeSet attrs) {
		super(context, attrs);
		this.context = context;
	...
	public StylesButton(Context context, AttributeSet attrs, int defStyleAttr) {
	...
	public StylesButton(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
