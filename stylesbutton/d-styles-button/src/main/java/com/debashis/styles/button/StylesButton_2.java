package com.debashis.styles.button;
...
//import android.support.annotation.RequiresApi;
 ...
 class StylesButton_2 extends LinearLayout {
	...
	public StylesButton_2(Context context) {
		super(context);
	...
	public StylesButton_2(Context context, AttributeSet attrs) {
		super(context, attrs);
		this.context = context;
	...
	public StylesButton_2(Context context, AttributeSet attrs, int defStyleAttr) {
	...
	public StylesButton_2(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
	...
	private void processAttributes(final Context context, final AttributeSet attrs) {
		...
		TypedArray attrsArray = context.obtainStyledAttributes(attrs, R.styleable.StylesButton, 0, 0);
		initAttributes(attrsArray);
		attrsArray.recycle();
	}
	...
	private void initAttributes(TypedArray attrs) {
		...
		radius = attrs.getDimension(R.styleable.StylesButton_debashis_radius, radius);

		borderColor = attrs.getColor(R.styleable.StylesButton_debashis_borderColor, borderColor);
		borderWidth = (int) attrs.getDimension(R.styleable.StylesButton_debashis_borderWidth, borderWidth);


		backgroundColor = attrs.getColor(R.styleable.StylesButton_debashis_backgroundColor, backgroundColor);
		disableColor = attrs.getColor(R.styleable.StylesButton_debashis_disableColor, disableColor);

		focusColor = attrs.getColor(R.styleable.StylesButton_debashis_focusColor, focusColor);

		text = attrs.getString(R.styleable.StylesButton_debashis_text);
		textColor = attrs.getColor(R.styleable.StylesButton_debashis_textColor, textColor);
		disabledTextColor = attrs.getColor(R.styleable.StylesButton_debashis_disabledTextColor, disabledTextColor);
		textSize = attrs.getDimensionPixelSize(R.styleable.StylesButton_debashis_textSize, textSize);

		textStyle = attrs.getInt(R.styleable.StylesButton_debashis_textStyle, textStyle);
		...
		textAllCaps = attrs.getBoolean(R.styleable.StylesButton_debashis_textAllCaps, textAllCaps);


		fontIcon = attrs.getString(R.styleable.StylesButton_debashis_fontIcon);
		iconSize = attrs.getDimensionPixelSize(R.styleable.StylesButton_debashis_iconSize, iconSize);
		iconColor = attrs.getColor(R.styleable.StylesButton_debashis_iconColor, iconColor);
		iconPosition = attrs.getInt(R.styleable.StylesButton_debashis_iconPosition, iconPosition);

		drawableResource = attrs.getResourceId(R.styleable.StylesButton_debashis_drawableResource, drawableResource);
		iconPadding = attrs.getDimensionPixelSize(R.styleable.StylesButton_debashis_iconPadding, iconPadding);

		lGravity = attrs.getInt(R.styleable.StylesButton_debashis_gravity, lGravity);
		isEnabled = attrs.getBoolean(R.styleable.StylesButton_debashis_enabled, isEnabled);
